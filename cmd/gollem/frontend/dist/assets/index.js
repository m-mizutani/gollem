...
function Layout({ children: children2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "text-lg font-semibold text-gray-800 hover:text-gray-600", children: "gollem trace viewer" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/license", className: "text-xs text-gray-400 hover:text-gray-600", children: "Licenses" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 p-6", children: children2 })
  ] });
}
const BASE_URL = "/api";
...
function computeDurationNs(startedAt, endedAt) {
...
function TraceHeader({ trace }) {
  ...
  const errorMsg = (_b2 = trace.root_span) == null ? void 0 : _b2.error;
  const tokens = trace.root_span ? collectTokens(trace.root_span) : { input: 0, output: 0 };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border border-gray-200 rounded-lg p-4 space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-lg font-mono font-semibold", children: trace.trace_id }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4 text-sm", children: [
      trace.metadata.model && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: "Model:" }),
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: trace.metadata.model })
      ] }),
      trace.metadata.strategy && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: "Strategy:" }),
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: trace.metadata.strategy })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: "Duration:" }),
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: formatDuration(duration) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: `inline-block px-2 py-0.5 rounded text-xs font-medium ${status === "ok" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`,
            children: status
          }
        )
      ] }),
    ...
    trace.metadata.labels && Object.keys(trace.metadata.labels).length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: Object.entries(trace.metadata.labels).map(([key, val]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "span",
      {
    ...
    errorMsg && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-red-50 border border-red-200 rounded p-3 text-sm text-red-700", children: errorMsg })
  ] });
}
const kindColors = {
...
function SpanNode({
  ...
  const isSelected = (selectedSpan == null ? void 0 : selectedSpan.span_id) === span.span_id;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `flex items-center gap-2 px-2 py-1.5 cursor-pointer text-sm hover:bg-gray-50 ${isSelected ? "bg-blue-50 border-l-2 border-blue-500" : ""}`,
        ...
        children: [
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-4 h-4 flex-shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `inline-block px-1.5 py-0.5 rounded text-xs font-medium ${kindColors[span.kind] || "bg-gray-100 text-gray-600"}`,
              children: span.kind.replace("_", " ")
            }
          ),
...
function SpanTree({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    SpanNode,
    {
      span: rootSpan,
      depth: 0,
...
const html$1 = merge([aria$1, html$2, xlink, xmlns, xml], "html");
...
function sanitize(node2, options) {
  ...
  const replace = transform(state, node2);
  if (replace) {
...
function MarkdownContent({ content: content2 }) {
  if (isJSON(content2)) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "bg-gray-900 text-gray-100 rounded p-3 text-xs overflow-auto max-h-96", children: /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: prettyJSON(content2) }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "prose prose-sm max-w-none prose-headings:mt-3 prose-headings:mb-1 prose-p:my-1 prose-ul:my-1 prose-ol:my-1 prose-li:my-0 prose-pre:my-2 prose-code:text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Markdown,
    {
      rehypePlugins: [rehypeSanitize],
      components: {
        pre: ({ children: children2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "bg-gray-900 text-gray-100 rounded p-3 text-xs overflow-auto", children: children2 }),
        code: ({ children: children2, className }) => {
          const isInline = !className;
          return isInline ? /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "bg-gray-100 text-gray-800 px-1 py-0.5 rounded text-xs", children: children2 }) : /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className, children: children2 });
        }
      },
      children: content2
    }
...
function JSONView({ data }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-1 right-1 flex gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "pre",
      {
        className: `bg-gray-900 text-gray-100 rounded p-3 text-xs overflow-auto ${collapsed ? "max-h-12" : "max-h-96"}`,
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: data })
      }
    )
  ] });
}
function LLMCallDetail({ data }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 text-sm", children: [
      data.model && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: "Model:" }),
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: data.model })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: "Input Tokens:" }),
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: data.input_tokens })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: "Output Tokens:" }),
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: data.output_tokens })
      ] })
    ] }),
    data.request && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-gray-700", children: "Request" }),
      data.request.system_prompt && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-gray-200 rounded", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: showSystemPrompt ? "▾" : "▸" }),
              "System Prompt"
            ]
          }
        ),
        showSystemPrompt && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2 border-t border-gray-200 text-sm prose prose-sm max-w-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MarkdownContent, { content: data.request.system_prompt }) })
      ] }),
      ...
      data.request.tools && data.request.tools.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h5", { className: "text-sm font-medium text-gray-600 mb-2", children: [
          "Tools (",
          data.request.tools.length,
          ")"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: data.request.tools.map((tool, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "px-3 py-1.5 bg-gray-50 rounded text-sm",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-medium", children: tool.name }),
              tool.description && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 ml-2", children: tool.description })
            ]
          },
          i
        )) })
    ...
    data.response && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-gray-700", children: "Response" }),
      data.response.texts && data.response.texts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "text-sm font-medium text-gray-600 mb-2", children: "Texts" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: data.response.texts.map((text2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "bg-gray-50 border border-gray-200 rounded p-3 text-sm prose prose-sm max-w-none",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(MarkdownContent, { content: text2 })
          },
          i
        )) })
      ] }),
      data.response.function_calls && data.response.function_calls.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "text-sm font-medium text-gray-600 mb-2", children: "Function Calls" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: data.response.function_calls.map((fc, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "border border-gray-200 rounded p-3",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-medium text-sm", children: fc.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-gray-400", children: [
                  "ID: ",
                  fc.id
                ] })
              ] }),
              fc.arguments && /* @__PURE__ */ jsxRuntimeExports.jsx(JSONView, { data: prettyJSON(fc.arguments) })
            ]
          },
          i
        )) })
...
function ToolExecDetail({ data }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: "Tool:" }),
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-medium", children: data.tool_name })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "text-sm font-medium text-gray-600 mb-1", children: "Arguments" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(JSONView, { data: prettyJSON(data.args) })
    ] }),
    data.result && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "text-sm font-medium text-gray-600 mb-1", children: "Result" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(JSONView, { data: prettyJSON(data.result) })
    ] }),
    data.error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-red-50 border border-red-200 rounded p-3 text-sm text-red-700", children: [
...
function EventDetail({ data }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: "Event Kind:" }),
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block px-1.5 py-0.5 rounded text-xs font-medium bg-orange-100 text-orange-700", children: data.kind })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "text-sm font-medium text-gray-600 mb-1", children: "Data" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(JSONView, { data: prettyJSON(data.data) })
    ] })
  ] });
}
...
function SpanDetail({ span }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-4 text-sm overflow-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-base", children: span.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-x-4 gap-y-1 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: "Kind:" }),
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block px-1.5 py-0.5 rounded text-xs font-medium bg-gray-100", children: span.kind })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: "Status:" }),
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `inline-block px-1.5 py-0.5 rounded text-xs font-medium ${span.status === "ok" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`,
              children: span.status
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: "Started:" }),
          " ",
          formatDateTime(span.started_at)
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: "Ended:" }),
          " ",
    ...
    span.error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-red-50 border border-red-200 rounded p-3 text-red-700", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Error:" }),
      " ",
      span.error
    ] }),
...
function flattenSpans(span, depth, result) {
...
function Timeline({ trace }) {
  ...
  const [hoveredSpan, setHoveredSpan] = reactExports.useState(null);
  const [tooltipPos, setTooltipPos] = reactExports.useState({ x: 0, y: 0 });
  const flatSpans = reactExports.useMemo(() => {
    if (!trace.root_span) return [];
    const result = [];
    flattenSpans(trace.root_span, 0, result);
    return result;
  }, [trace]);
  const traceStartMs = reactExports.useMemo(
    () => new Date(trace.started_at).getTime(),
    [trace]
  );
  const traceEndMs = reactExports.useMemo(
  ...
  const msToX = reactExports.useCallback(
    (ms) => {
  ...
  const scaleMarks = reactExports.useMemo(() => {
    const marks = [];
    if (traceDurationMs === 0) return marks;
    const step = Math.pow(10, Math.floor(Math.log10(traceDurationMs)));
    const nice = traceDurationMs / step < 3 ? step / 2 : traceDurationMs / step < 6 ? step : step * 2;
    for (let ms = 0; ms <= traceDurationMs; ms += nice) {
      marks.push({
        ms,
        label: formatDuration(ms * 1e6)
      });
    }
    return marks;
  }, [traceDurationMs]);
  ...
  if (flatSpans.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white border border-gray-200 rounded-lg p-8 text-center text-gray-500", children: "No span data available" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white border border-gray-200 rounded-lg p-4 overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ref: svgRef,
      width: chartWidth,
      ...
      children: [
        scaleMarks.map((mark2, i) => {
          const x = msToX(mark2.ms);
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "text",
              {
                ...
                fill: "#9ca3af",
                fontSize: 10,
                children: mark2.label
              }
            )
          ] }, i);
        }),
        flatSpans.map((fs) => {
          const spanStartMs = new Date(fs.span.started_at).getTime() - traceStartMs;
          const spanDurationMs = fs.span.duration / 1e6;
          ...
          const color2 = SPAN_COLORS[fs.span.kind] || "#94a3b8";
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "text",
                  {
                    ...
                    fontSize: 11,
                    className: "truncate",
                    children: fs.span.name.length > 20 ? fs.span.name.slice(0, 18) + ".." : fs.span.name
                  }
                ),
                isEvent ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "circle",
                  {
                    cx: x,
                    cy: y + ROW_HEIGHT / 2,
        ...
        hoveredSpan && (() => {
          ...
          const tx = tooltipPos.x + tooltipWidth > chartWidth ? tooltipPos.x - tooltipWidth - 10 : tooltipPos.x;
          const ty = tooltipPos.y + tooltipHeight > chartHeight ? tooltipPos.y - tooltipHeight : tooltipPos.y;
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            "foreignObject",
            {
              x: tx,
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-900 text-white text-xs rounded px-3 py-2 shadow-lg", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium", children: hoveredSpan.span.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-gray-300 mt-1", children: [
                  "Kind: ",
                  hoveredSpan.span.kind,
                  " | Duration:",
                  " ",
                  formatDuration(hoveredSpan.span.duration),
                  " | Status:",
                  " ",
...
function LLMCallList({ trace }) {
  const [expandedSeq, setExpandedSeq] = reactExports.useState(null);
  ...
  const totals = reactExports.useMemo(() => {
    return calls.reduce(
      (acc, c) => {
        var _a2, _b2;
        return {
          input: acc.input + (((_a2 = c.span.llm_call) == null ? void 0 : _a2.input_tokens) ?? 0),
          output: acc.output + (((_b2 = c.span.llm_call) == null ? void 0 : _b2.output_tokens) ?? 0),
  ...
  if (calls.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white border border-gray-200 rounded-lg p-8 text-center text-gray-500 text-sm", children: "No LLM calls in this trace" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white border border-gray-200 rounded-lg p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-6 text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: "LLM Calls:" }),
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: calls.length })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: "Total Tokens:" }),
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-medium", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: "Total LLM Duration:" }),
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: formatDuration(totals.duration) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: calls.map((entry) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `bg-white border rounded-lg ${isError ? "border-red-300" : "border-gray-200"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
            ...
            isExpanded && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-4 border-t border-gray-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LLMCallDetail, { data: llm }) }) })
          ]
        },
        entry.seq
      );
...
function TraceDetailPage() {
  ...
  if (error) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-red-50 border border-red-200 rounded-lg p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-red-600 mt-2", children: error.message }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: "/",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-gray-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex gap-6", children: tabs.map((tab2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        className: `pb-2 text-sm font-medium border-b-2 transition-colors ${activeTab === tab2.key ? "border-blue-600 text-blue-600" : "border-transparent text-gray-500 hover:text-gray-700"}`,
        children: tab2.label
      },
      tab2.key
    )) }) }),
    activeTab === "overview" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", style: { minHeight: "500px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2/5 overflow-auto border border-gray-200 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        SpanTree,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3/5 overflow-auto border border-gray-200 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpanDetail, { span: selectedSpan }) })
    ] }),
    activeTab === "timeline" && /* @__PURE__ */ jsxRuntimeExports.jsx(Timeline, { trace }),
    activeTab === "llm_calls" && /* @__PURE__ */ jsxRuntimeExports.jsx(LLMCallList, { trace })
  ] });
}
function LicensePage() {
  ...
  if (error) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-red-50 border border-red-200 rounded-lg p-4 text-red-700", children: [
      "Failed to load licenses: ",
      error
    ] }) });
  }
  if (content2 === null) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto text-gray-500", children: "Loading licenses..." });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-lg font-semibold mb-4", children: "Third-Party Licenses" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "bg-gray-50 border border-gray-200 rounded-lg p-4 text-xs overflow-auto whitespace-pre-wrap max-h-[80vh]", children: content2 })
  ] });
}
function App() {
